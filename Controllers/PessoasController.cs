...
namespace ProvaYagoDS2.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(ProvaYagoDS2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PessoaId,Nome,Profissao,Idade")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PessoaId,Nome,Profissao,Idade")] Pessoa pessoa)
        {
